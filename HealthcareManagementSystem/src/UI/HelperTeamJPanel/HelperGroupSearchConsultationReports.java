...
public class HelperGroupSearchConsultationReports extends javax.swing.JPanel {
    ...
    HelperTeam customerSupportTeam;
    ...
    private void jButtonLabSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLabSearchActionPerformed
        ...
        for(PartnerInfirmiries hospital: infirmiries){
            if(hospital.getInfirmary_postcode().equals(user_input.get(1))){
                ArrayList<Consultation> labTestList = hospital.getLabTestDirectory().getTest_results_List();
    ...
    private void insertDataInJTable() {
        ...
        ArrayList<ConsumerRecords> data_List = userAccountDirectory.get_User_Details();
        
        model.setRowCount(0);
        for(ConsumerRecords consumerData: data_List)
        {   
            System.out.println("userAccount.getRole().toString(): "+consumerData.getRole().toString());
            if(consumerData.getRole().toString() == "CustomerSupportMember" && consumerData.getRole().equals(customerSupportTeam)){
                
                accountantDirectory = customerSupportTeam.getCustomerSupportMemberDirectory();
                HashMap<String, RegisteredMember> accountantList = accountantDirectory.getRegisteredSupportMemberList();
                RegisteredMember accountant = accountantList.get(consumerData.getEmail_Id());
                model.addRow(new Object[]{consumerData,accountant.getQualifiedMemberName(),consumerData.getPassword()});
            }
        }
    ...
    private void fillAllPratitionerDetails(String pincode) {
        ...
        jComboBoxListOfHospital.removeAllItems();
        PartnerInfirmiriesDirectory hospitalDirectory = healthcareSystemOrganizationIntegration.getInfirmaryDirectory();
            ArrayList<PartnerInfirmiries> hospitalList = hospitalDirectory.getHospitalList();
